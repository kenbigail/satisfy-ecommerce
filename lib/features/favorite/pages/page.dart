        ...
        child: Column(
          children: [
            Container(
              ...
              color: Colors.white,
              child: Center(
                child: Text('Favorites', style: GoogleFonts.inter(
    ...
    return Expanded(
      child: Center(
        child: Column(
          ...
          children: [
            Text('no favorite satisfy products', style: GoogleFonts.inter(
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                shape: RoundedRectangleBorder( // Set shape (optional)
                  borderRadius: BorderRadius.circular(15), // Rounded corners
                ),
              ),
              child: Text('Explore', style: GoogleFonts.inter(
                  fontSize: 15,
                  fontWeight: FontWeight.w500,
                  color: Colors.white
              ),),
